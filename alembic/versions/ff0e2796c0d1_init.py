...
Revision ID: ff0e2796c0d1
Revises: 
Create Date: 2024-04-18 13:40:24.199445
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["event_localization_id"],
            ["event_localization.id"],
        ),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_table(
        "sport_localization_association",
        sa.Column("id", sa.Uuid(), nullable=False),
        sa.Column("sport_id", sa.Uuid(), nullable=False),
        ...
        sa.ForeignKeyConstraint(
            ["sport_localization_id"],
            ["sport_localization.id"],
        ),
    ...
    op.create_table(
        "ticket_localization_assiciation",
        sa.Column("id", sa.Uuid(), nullable=False),
        ...
        sa.ForeignKeyConstraint(
            ["ticket_localization_id"],
            ["ticket_localization.id"],
        ),
